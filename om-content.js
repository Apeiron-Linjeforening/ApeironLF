/* Innhold for Om oss-siden (om-oss.html) — TEKST-delene som endres ofte.
   ...
   Dekker:
     ...
     samarbeid: «Fellesskap & samarbeid» — intro + kort (Unionen/Dionysos/Begrep)
     lesesalen: «Lesesalen» — intro + tjeneste-punkter
     motStyret: «Møt styret» — intro + kort
   ...
   Disse delene ligger ANNETSTEDS:
     ...
     - Lesesalen-bildene                → assets/lesesalen/ (filer i repoet)
*/

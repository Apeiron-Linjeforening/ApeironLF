...
(function () {
  ...
  AdminPanels.define('marked', {
    ...
    mount: function (host, AC) {
      host.innerHTML =
        ...
        + '<div class="tip">'
          ...
          + '<ol>'
            ...
            + '<li>Erstatt <code>marked-content.js</code> i GitHub-repositoriet og push/commit</li>'
      ...
      function onPreviewMsg(e) { if (e.data && e.data.type === 'apeiron-marked-preview-ready') { pushPreview(); fitPreview(); } }
      function fitPreview() {

...
(function () {
  ...
  AdminPanels.define('galleri', {
    ...
    mount: function (host, AC) {
      host.innerHTML =
        ...
        + '<div class="tip">'
          ...
          + '<ol>'
            ...
            + '<li>Erstatt <code>galleri-content.js</code> i GitHub-repositoriet og push/commit</li>'
      ...
      function onPreviewMsg(e) { if (e.data && e.data.type === 'apeiron-galleri-preview-ready') { pushPreview(); fitPreview(); } }
      function fitPreview() {

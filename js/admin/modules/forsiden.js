        ...
        + '<div class="panel" data-sec-key="__gallery"><h2>Galleribilder på forsiden <small>live fra Drive-galleriet</small></h2>'
          + '<div class="panel-body">'
            + '<style>'
              ...
              + '.hg-body{margin-top:11px;transition:opacity .2s}'
              + '.hg-body.is-off{opacity:.4;pointer-events:none}'
              + '.hg-body .fg{margin-bottom:7px}'
              + '.hg-grp{margin-bottom:11px}'
              + '.hg-grp:last-child{margin-bottom:0}'
              + '.hg-grp__h{font-size:.64rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--ink-soft);padding-bottom:5px;margin-bottom:8px;border-bottom:1px solid var(--border)}'
              ...
              + '.hg-body .fg.narrow{flex:1 1 130px}'
              + '.hg-body .fg label{display:flex;align-items:center;gap:4px;white-space:nowrap}'
              + '.hg-help{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;border-radius:50%;background:#cdd2e0;color:#2b2c33;font-size:9px;font-weight:700;cursor:help}'
            ...
            + '<div class="hg-body" id="hg-body">'
              ...
              + '<div class="hg-grp" data-hg="extras">'
                ...
                + '<div class="frow">'
                  ...
                  + '</select></div>'
                + '</div>'
                + '<label class="hg-toggle" data-hg="navclip"><input type="checkbox" id="hg-navclip"> Klipp bildene ved navigasjonsbaren<span class="hg-help" title="Skjuler den delen av bildene som havner bak topptekst/menyen, så de ikke overlapper navigasjonen.">?</span></label>'
                + '<div data-hg="section">'

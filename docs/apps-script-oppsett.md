...
Nettsiden er statisk og har ingen egen server. Merch-bestilling bruker derfor
Google Sheets + Apps Script som gratis «backend»: handlekurven sender bestillinger

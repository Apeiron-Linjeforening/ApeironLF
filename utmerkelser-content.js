/* Innhold for Utmerkelser-siden (utmerkelser.html).
   ...
   Rediger direkte her, eller åpne Admin-senteret → Utmerkelser for visuell redigering.
   ...
   people[].year  : årskull (studieår), f.eks. "2024/2025". Brukes til filtrering på siden.
